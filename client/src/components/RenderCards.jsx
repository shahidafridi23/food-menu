...
import DefaultFoodImg from "../assets/defaultfoodimg.jpg";
...
const Card = ({ _id, name, price, description, isavailable, image }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute overflow-scroll top-32 left-0 w-full bg-white text-black slide-up-content transform rounded-3xl transition-transform ${
